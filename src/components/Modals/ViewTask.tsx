  ...
  return (
    <Modal>
      <div className='ViewTask'>
        ...
        <p className='ViewTask__descWrapper'>{ModalDetail.description ? ModalDetail.description : 'Sem descrição'}</p>

        <div className='ViewTask__subtaskWrapper'>
          <p className='ViewTask__sub-title'>
            Subtarefas ({countCompleted?.length} de {ModalDetail.subtasks?.length})
          </p>
          {ModalDetail.subtasks.length === 0 && <p className='ViewTask__noSubTask'>Sem subtarefas.</p>}
        ...
        <div className='ViewTask__statusWrapper'>
          <p className='ViewTask__sub-title'>Status atual</p>
